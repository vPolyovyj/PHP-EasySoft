...
class esDemo
{
	...
	public function getCompany() { return array(); }
	...
	public function prepay($account, $sum, $dt, $order) { return $this->generateCheckRef(); }

	public function confirm($paymentId, $dt) { return true; }

	public function cancel($paymentId) { return true; }
}
